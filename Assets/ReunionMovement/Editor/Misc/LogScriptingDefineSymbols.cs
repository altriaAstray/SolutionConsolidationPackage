...
namespace GameLogic.Editor
{
    ...
    public static class LogScriptingDefineSymbols
    {
        ...
        /// 禁用所有日志脚本宏定义。
        /// </summary>
        [MenuItem("GameLogic/日志宏定义/禁用所有日志", false, 1)]
        ...
        /// 开启所有日志脚本宏定义。
        /// </summary>
        [MenuItem("GameLogic/日志宏定义/开启所有日志", false, 2)]
        ...
        /// 开启调试及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("GameLogic/日志宏定义/开启调试及以上级别的日志", false, 3)]
        ...
        /// 开启信息及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("GameLogic/日志宏定义/开启信息及以上级别的日志", false, 4)]
        ...
        /// 开启警告及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("GameLogic/日志宏定义/开启警告及以上级别的日志", false, 5)]
        ...
        /// 开启错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("GameLogic/日志宏定义/开启错误及以上级别的日志", false, 6)]
        ...
        /// 开启严重错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("GameLogic/日志宏定义/开启严重错误及以上级别的日志", false, 7)]
