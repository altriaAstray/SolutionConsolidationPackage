...
namespace GameLogic
{
    ...
    public class GameLogicLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        //链表数据
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new GameLogicException("First is invalid.");
            }
        ...
        public void RemoveLast()
        {
            ...
            if (last == null)
            {
                throw new GameLogicException("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new GameLogicException("Linked list is invalid.");
                }
