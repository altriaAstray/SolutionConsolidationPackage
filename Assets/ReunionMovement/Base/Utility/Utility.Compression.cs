    ...
    public static partial class Utility
    {
        ...
        public static partial class Compression
        {
            ...
            public static byte[] Compress(byte[] bytes)
            {
                if (bytes == null)
                {
                    throw new GameLogicException("Bytes is invalid.");
                }
            ...
            public static bool Compress(byte[] bytes, int offset, int length, Stream compressedStream)
            {
                ...
                {
                    throw new GameLogicException("Compressed helper is invalid.");
                }
                ...
                {
                    throw new GameLogicException("Offset or length is invalid.");
                }

                if (compressedStream == null)
                {
                    throw new GameLogicException("Compressed stream is invalid.");
                }
                ...
                {
                    if (exception is GameLogicException)
                    {
                        throw;
                    }

                    throw new GameLogicException(Text.Format("Can not compress with exception '{0}'.", exception), exception);
                }
            }
            ...
            public static bool Compress(Stream stream, Stream compressedStream)
            {
                ...
                if (stream == null)
                {
                    throw new GameLogicException("Stream is invalid.");
                }
            ...
            public static bool Decompress(byte[] bytes, int offset, int length, Stream decompressedStream)
            {
                ...
                {
                    throw new GameLogicException("Decompressed stream is invalid.");
                }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new GameLogicException(Text.Format("Can not decompress with exception '{0}'.", exception), exception);
                }
            }
